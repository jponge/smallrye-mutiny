...
public class MultiOnCancellationInvoke<T> extends AbstractMultiOperator<T, T> {
    ...
    public MultiOnCancellationInvoke(@NotNull Multi<? extends T> upstream, @NotNull Runnable action) {
    ...
    class MultiOnCancellationInvokeProcessor extends MultiOperatorProcessor<T, T> {
        ...
        public MultiOnCancellationInvokeProcessor(@NotNull MultiSubscriber<? super T> downstream) {
            super(downstream);
        }
