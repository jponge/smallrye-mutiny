...
public class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends Tuple6<T1, T2, T3, T4, T5, T6> implements Tuple { //NOSONAR
    ...
    @Override
    public <T> Tuple7<T, T2, T3, T4, T5, T6, T7> mapItem1(@NotNull Function<T1, T> mapper) {
        return Tuple7.of(mapper.apply(item1), item2, item3, item4, item5, item6, item7);
    }

    @Override
    public <T> Tuple7<T1, T, T3, T4, T5, T6, T7> mapItem2(@NotNull Function<T2, T> mapper) {
        return Tuple7.of(item1, mapper.apply(item2), item3, item4, item5, item6, item7);
    }

    @Override
    public <T> Tuple7<T1, T2, T, T4, T5, T6, T7> mapItem3(@NotNull Function<T3, T> mapper) {
        return Tuple7.of(item1, item2, mapper.apply(item3), item4, item5, item6, item7);
    }

    @Override
    public <T> Tuple7<T1, T2, T3, T, T5, T6, T7> mapItem4(@NotNull Function<T4, T> mapper) {
        return Tuple7.of(item1, item2, item3, mapper.apply(item4), item5, item6, item7);
    }

    @Override
    public <T> Tuple7<T1, T2, T3, T4, T, T6, T7> mapItem5(@NotNull Function<T5, T> mapper) {
        return Tuple7.of(item1, item2, item3, item4, mapper.apply(item5), item6, item7);
    }

    @Override
    public <T> Tuple7<T1, T2, T3, T4, T5, T, T7> mapItem6(@NotNull Function<T6, T> mapper) {
        return Tuple7.of(item1, item2, item3, item4, item5, mapper.apply(item6), item7);
    }

    public <T> Tuple7<T1, T2, T3, T4, T5, T6, T> mapItem7(@NotNull Function<T7, T> mapper) {
