...
public class Tuple5<T1, T2, T3, T4, T5> extends Tuple4<T1, T2, T3, T4> implements Tuple {
    ...
    @Override
    public <T> Tuple5<T, T2, T3, T4, T5> mapItem1(@NotNull Function<T1, T> mapper) {
        return Tuple5.of(mapper.apply(item1), item2, item3, item4, item5);
    }

    @Override
    public <T> Tuple5<T1, T, T3, T4, T5> mapItem2(@NotNull Function<T2, T> mapper) {
        return Tuple5.of(item1, mapper.apply(item2), item3, item4, item5);
    }

    @Override
    public <T> Tuple5<T1, T2, T, T4, T5> mapItem3(@NotNull Function<T3, T> mapper) {
        return Tuple5.of(item1, item2, mapper.apply(item3), item4, item5);
    }

    @Override
    public <T> Tuple5<T1, T2, T3, T, T5> mapItem4(@NotNull Function<T4, T> mapper) {
        return Tuple5.of(item1, item2, item3, mapper.apply(item4), item5);
    }

    public <T> Tuple5<T1, T2, T3, T4, T> mapItem5(@NotNull Function<T5, T> mapper) {
