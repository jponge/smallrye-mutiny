...
public class Tuple6<T1, T2, T3, T4, T5, T6> extends Tuple5<T1, T2, T3, T4, T5> implements Tuple {
    ...
    @Override
    public <T> Tuple6<T, T2, T3, T4, T5, T6> mapItem1(@NotNull Function<T1, T> mapper) {
        return Tuple6.of(mapper.apply(item1), item2, item3, item4, item5, item6);
    }

    @Override
    public <T> Tuple6<T1, T, T3, T4, T5, T6> mapItem2(@NotNull Function<T2, T> mapper) {
        return Tuple6.of(item1, mapper.apply(item2), item3, item4, item5, item6);
    }

    @Override
    public <T> Tuple6<T1, T2, T, T4, T5, T6> mapItem3(@NotNull Function<T3, T> mapper) {
        return Tuple6.of(item1, item2, mapper.apply(item3), item4, item5, item6);
    }

    @Override
    public <T> Tuple6<T1, T2, T3, T, T5, T6> mapItem4(@NotNull Function<T4, T> mapper) {
        return Tuple6.of(item1, item2, item3, mapper.apply(item4), item5, item6);
    }

    @Override
    public <T> Tuple6<T1, T2, T3, T4, T, T6> mapItem5(@NotNull Function<T5, T> mapper) {
        return Tuple6.of(item1, item2, item3, item4, mapper.apply(item5), item6);
    }

    public <T> Tuple6<T1, T2, T3, T4, T5, T> mapItem6(@NotNull Function<T6, T> mapper) {
