...
public abstract class Tuples {
    ...
    public static <L, R> Tuple2<L, R> tuple2(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3> Tuple3<T1, T2, T3> tuple3(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> tuple4(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> tuple5(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> tuple6(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> tuple7(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> tuple8(@NotNull List<?> list) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple9(@NotNull List<?> list) {
    ...
    public static void ensureArity(@NotNull List<?> parameters, int expectedSize) {
