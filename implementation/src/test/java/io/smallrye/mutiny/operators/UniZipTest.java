...
public class UniZipTest {
    ...
    public void testWithArraysAndOneFailure() {
        ...
        assertThatThrownBy(() ->
                Uni.combine().all().unis(uni1, uni2, uni3, uni4, uni5, uni6, uni7, uni8, uni9, uni10)
                        .combinedWith(l -> l.stream().mapToInt(o -> (Integer) o).sum())
                        .await().indefinitely()
    ...
    public void testWithArraysAndMultipleFailures() {
        ...
        assertThatThrownBy(() ->
                Uni.combine().all().unis(uni1, uni2, uni3, uni4, uni5, uni6, uni7, uni8, uni9, uni10)
                        .combinedWith(l -> l.stream().mapToInt(o -> (Integer) o).sum())
                        .await().indefinitely()
        ).isInstanceOf(UncheckedIOException.class).hasMessageContaining("io");
    ...
    public void testWithArraysAndMultipleFailuresAndFailureCollection() {
        ...
        assertThatThrownBy(() ->
                Uni.combine().all().unis(uni1, uni2, uni3, uni4, uni5, uni6, uni7, uni8, uni9, uni10)
                        ...
                        .combinedWith(l -> l.stream().mapToInt(o -> (Integer) o).sum())
                        .await().indefinitely()
        ).isInstanceOfSatisfying(CompositeException.class, t -> {
