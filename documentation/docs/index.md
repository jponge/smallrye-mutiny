...
Mutiny is based on the [Reactive Streams specification](https://www.reactive-streams.org/) and [Java Flow](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/Flow.html), and so it can be integrated with any other reactive programming library.
